...
Most people skip half of it or write lazy listings that don't sell. Listd does all of this for you — including telling you which photos to retake before you even start.
...
- Depop OAuth integration — connect your Depop account, post directly from Listd
...
- **Listd** (current) — clean, action-oriented
