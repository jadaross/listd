...
struct RootView: View {
    ...
    private let theme = BowerTheme.warm
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            if !hideTabBar {
                BowerTabBar(screen: $state.screen, theme: theme)
    ...
    @ViewBuilder private var header: some View {
        ...
        case .home, .history, .settings:
            HStack {
                ...
                Spacer()
                Text(headerTitle)
                    .font(headerTitle == "bower" ? BowerFont.serif(22) : BowerFont.ui(17, weight: .semibold))
